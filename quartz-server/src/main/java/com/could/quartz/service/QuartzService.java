package com.could.quartz.service;
...
public class QuartzService {
	 ...
	 * @param jobData      参数
	 */
	public void addCronJob(Class<? extends QuartzJobBean> jobClass, String jobName, String jobGroupName, String jobTime,
			Map<String, String> jobData) {
		if (jobClass == null) {
			log.error("add cronJob error : jobClass is null");
			return;
		}
		try {
